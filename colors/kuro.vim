...
let s:blue_text                   = {"ctermbg": s:black,  "ctermfg": s:blue}
...
call s:h("WarningMsg",      s:yellow_text)
...
call s:h("PmenuThumb",      s:grey1_text)
...
call s:h("PmenuSel",        s:white_text_grey3_highlight)
call s:h("NonText",         s:invisible_text)
call s:h("QuickFixLine",    s:none)
call s:h("DiagnosticError", s:red_text)
call s:h("DiagnosticWarn",  s:yellow_text)
call s:h("DiagnosticInfo",  s:blue_text)
call s:h("DiagnosticHint",  s:blue_text)
